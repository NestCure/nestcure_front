...
class _RegisterPageState extends State<RegisterPage> {
  ...
  final TextEditingController _experienciaPreviaController =
      TextEditingController();
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      String experienciaPrevia =
                          _experienciaPreviaController.text;
                      ...
                      if (_registeredEmails.contains(correu)) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                              content: Text('Usuari registrat correctament')),
                        );
                      } else {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                              content: Text('Has de completar tots els camps')),
                        );
                      }
                    },
                    style: ElevatedButton.styleFrom(
